import { CreateServiceReturnType, FindByIdServiceReturnType } from './crud-interfaces'
import { DeleteByIdServiceReturnType, UpdateByIdServiceReturnType } from './crud-interfaces'
